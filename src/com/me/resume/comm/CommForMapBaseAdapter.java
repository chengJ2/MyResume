...
public  abstract class CommForMapBaseAdapter extends BaseAdapter {
	...
	public CommForMapBaseAdapter(Context context,Map<String,List<String>> mList,int LayoutID,String valueId){
	...
	public abstract void convert(ViewHolder holder,List<String> item,int position);

...
public class SegmentButton extends LinearLayout implements View.OnClickListener {
	...
	public SegmentButton(Context context, AttributeSet attrs) {
		...
		textPressColor = typedArray.getColor(R.styleable.SegmentButton_textPressColor, Color.WHITE);
		textNormalColor = typedArray.getColor(R.styleable.SegmentButton_textNormalColor,Color.BLACK);
